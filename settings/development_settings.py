"""
Django settings for HealthThink project.
...
SECRET_KEY = '3hz8%oug=3glaa==l15!s=9ao&$v^(+56m-9x7f3ny#7bi2sfl'
...
WSGI_APPLICATION = 'HealthThink.wsgi.application'
